...
local Window = Library:NewWindow({
    ...
    UITheme = Color3.fromRGB(255, 0, 0), -- Changes the global theme dynamically
    ConfigFolder = "KingRuaFolder" -- The folder that saves will be stored inside Workspace
})

-- Example usage of the decoupled Mobile Toggle
